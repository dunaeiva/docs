...
* [{{ foundation-models-full-name }}]({{ link-docs-ai }}ai-studio/pricing)
    * [Text generation in {{ gpt-lite }} or {{ gpt-pro }}]({{ link-docs-ai }}ai-studio/pricing#pricing-generating)
    * [Text vectorization in {{ foundation-models-full-name }}]({{ link-docs-ai }}ai-studio/pricing#pricing-embedding)
...
* [{{ speechsense-full-name }}](../speechsense/pricing.md)
    * [Conversation audio analysis](../speechsense/pricing.md#speech)
    * [Chat transcript analysis](../speechsense/pricing.md#text)
