The `kspm.worker` role allows the user to view info on Managed Service for Kubernetes [clusters](../../managed-kubernetes/concepts/index.md#kubernetes-cluster) and install [{{ kspm-name }}](../../security-deck/concepts/kspm.md) components in them.
