...
- Management console {#console}
  ...
  1. Create a private subnet:
        ...
        1. In the **{{ ui-key.yacloud.baremetal.field_CIDR_rwYMi }}** field, specify `172.28.4.0/24`.
        1. In the **{{ ui-key.yacloud.baremetal.field_gateway_t7LLk }}** field, keep the default value, `172.28.4.1`.
