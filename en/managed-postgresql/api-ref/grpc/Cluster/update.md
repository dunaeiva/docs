...
# Managed Service for PostgreSQL API, gRPC: ClusterService.Update

Updates the specified PostgreSQL cluster.

## gRPC request

**rpc Update ([UpdateClusterRequest](#yandex.cloud.mdb.postgresql.v1.UpdateClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateClusterRequest {#yandex.cloud.mdb.postgresql.v1.UpdateClusterRequest}
...
|| metadata | **[UpdateClusterMetadata](#yandex.cloud.mdb.postgresql.v1.UpdateClusterMetadata)**
...
## UpdateClusterMetadata {#yandex.cloud.mdb.postgresql.v1.UpdateClusterMetadata}
