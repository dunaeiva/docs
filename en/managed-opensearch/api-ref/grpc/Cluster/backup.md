...
# Managed Service for OpenSearch API, gRPC: ClusterService.Backup

Creates a backup for the specified OpenSearch cluster.

## gRPC request

**rpc Backup ([BackupClusterRequest](#yandex.cloud.mdb.opensearch.v1.BackupClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## BackupClusterRequest {#yandex.cloud.mdb.opensearch.v1.BackupClusterRequest}
