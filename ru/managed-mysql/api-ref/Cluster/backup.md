...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mysql/v1/clusters/{clusterId}:backup
    method: post
    path:
      type: object
      properties:
...
# Managed Service for MySQL API, REST: Cluster.Backup

Creates a backup for a cluster.

To get information about a backup, make a [BackupService.Get](/docs/managed-mysql/api-ref/Backup/get#Get) request.
