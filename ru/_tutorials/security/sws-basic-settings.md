---
title: Первичная настройка защиты в {{ sws-name }}
description: Руководство помогает с нуля настроить защиту вашего сервиса с помощью {{ sws-full-name }}.
---
...
В наборе OWASP надо настроить два параметра:
