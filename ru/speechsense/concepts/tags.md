...
Чтобы создавать эффективные поисковые запросы, которые будут использоваться для назначения смысловых Pro-тегов, ознакомьтесь с [Руководство по проектированию промптов]({{ link-docs-ai }}ai-studio/gpt-prompting-guide/about).
