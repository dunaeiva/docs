...
* `yc.ai.foundationModels.execute` — для отправки запросов к [{{ assistant-api }}]({{ link-docs-ai }}ai-studio/assistants/api-ref/index), [Image Generation API]({{ link-docs-ai }}ai-studio/image-generation/api-ref/index), [Text Generation API]({{ link-docs-ai }}ai-studio/text-generation/api-ref/index), [API {{ speechkit-name }}]({{ link-docs-ai }}speechkit/concepts/api), [API {{ translate-full-name }}]({{ link-docs-ai }}translate/concepts/api) и [{{ vision-name }} API]({{ link-docs-ai }}vision/ocr/api-ref/index).
* `yc.ai.imageGeneration.execute` — для отправки запросов к моделям генерации изображений в сервисе {{ foundation-models-full-name }} через [Image Generation API]({{ link-docs-ai }}ai-studio/image-generation/api-ref/index).
* `yc.ai.languageModels.execute` — для отправки запросов к моделям генерации текста в сервисе {{ foundation-models-full-name }} через [Text Generation API]({{ link-docs-ai }}ai-studio/text-generation/api-ref/index).
...
* `yc.serverless.mcpGateways.invoke` — для вызова [MCP-серверов](../../../glossary/mcp.md) через [{{ foundation-models-full-name }} {{ mcp-hub-name }}]({{ link-docs-ai }}ai-studio/concepts/mcp-hub/index).
