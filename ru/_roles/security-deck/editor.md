...
* просматривать информацию о [кластерах](../../managed-kubernetes/concepts/index.md#kubernetes-cluster) Managed Service for Kubernetes, подключенных к {{ kspm-name }}, пользователях {{ kspm-name }} и операциях в модуле;
