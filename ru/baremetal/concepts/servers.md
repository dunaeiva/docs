...
Сервер может предоставляться пользователю как в одной из [готовых конфигураций](./server-configurations.md#standard), так и в [конфигурации](./server-configurations.md#custom), собранной по [запросу](../operations/servers/custom-server-lease.md) пользователя.
