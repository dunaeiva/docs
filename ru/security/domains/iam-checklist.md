...
&#x2713; **Использование политик авторизации для запрета определенных операций в каталоге, облаке или организации**: с помощью [политик авторизации](../../iam/concepts/access-control/access-policies.md) вы можете запретить выполнение некоторых операций в определенном каталоге, облаке или организации. Если политика авторизации запрещает операцию, то эта операция будет заблокирована, даже если у пользователя есть роль, разрешающая ее.
...
&#x2713; **Ограничение использования сервисных аккаунтов с помощью политик авторизации**: вы можете использовать политики авторизации, чтобы ограничить создание сервисных аккаунтов и их ключей, а также использование имперсонации в определенных каталогах, облаках или организациях. Подробнее читайте в разделе [{#T}](../../iam/concepts/access-control/access-policies.md).
